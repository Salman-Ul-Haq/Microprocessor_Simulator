      ...
      <Table borderStyle={{ borderWidth: 1 }}>
        ...
        <TableWrapper style={styles.wrapper}>
          ...
          <View style={{flex: 1, backgroundColor:'lightgrey',borderWidth:2, borderColor: 'black', marginTop: 1}}>
            <TextInput editable={false} style={styles.textes}></TextInput>
            </View>
            
          <View style={{ flex: 1.5, backgroundColor: "#E7F7EB" }}>
          <Text style={styles.decoderflagtxt} >DECODER</Text>
          <TextInput editable={false} style={{marginTop: 6, borderWidth:2, borderColor: 'black', backgroundColor:'orange', fontSize:20}}></TextInput>
